...
public class Exercise_14_21_Two_Circles_Distance extends Application {
	...
	public void start(Stage primaryStage) {
		...
		// Create two circles
		Circle circle1 = new Circle(Math.random() * 201, Math.random() * 201, 15); // random
		...
		// Calculate distance between the two centers of the circles
